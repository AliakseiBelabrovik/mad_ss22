...
/*
fun getMovieById( movieId : String = getMovies()[0].id ) : Movie {
    return getMovies().filter { movie -> movie.id.equals(movieId) }[0]
    //return getMovies().find { movie -> movie.id.equals(movieId) }
}
